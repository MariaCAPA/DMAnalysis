...
TGraph * grshadeNaI;
TGraph * grshadetotCm;
compRateSum(double si=1e-4, double mass=10)
{
...
htotC->SetLineColor(kRed-2);
htotCl->SetLineColor(kRed-2);
htotCh->SetLineColor(kRed-2);
...
htotC->GetYaxis()->SetRangeUser(1e-7,100);
...
grshadetotC->SetFillColor(kRed-2);
grshadetotC->Draw("f");
...
htotCm->SetLineColor(kRed-2);
htotClm->SetLineColor(kRed-2);
htotChm->SetLineColor(kRed-2);
...
htotCm->GetYaxis()->SetRangeUser(-0.15,0.25);
//htotT->Draw("lsame");
...
grshadetotCm->SetFillColor(kRed-2);
